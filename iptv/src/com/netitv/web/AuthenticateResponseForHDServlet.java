...
public class AuthenticateResponseForHDServlet extends HttpServlet {
	...
	private static Logger logger = Logger.getLogger(AuthenticateResponseForHDServlet.class);
	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		logger.debug("=====AuthenticateResponseForHD begin ========");
		...
		if("0".equals(Result) &&  action_url != null){
			...
			}else if( action_url != null && action_url.indexOf("/crazyenglish_hd/filmAction!engIndex.do")>0){
		...
		logger.debug("=====AuthenticateResponseForHD end ========");
	}
