...
function keyEvent() {
	...
	case 283:
			if(from == "index"){
				...
				location.href = "${ctx }/crjy/filmAction!listFilmByColumnId.do?columnId=" +columnID +"&channelId=3";
			}
			else{
				location.href = "${ctx }/crjy/filmAction!eduIndex.do";
			}
  ...
  <tr>
    ...
    <td width="575" valign="top" bgcolor="214c47"><table width="575" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="555" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="144" height="44" valign="top" class="STYLE18">集数：${film.serialCount }集      <br/>价格：20元包月</td>
          <td width="144" height="44" valign="top" class="STYLE18">适用：${film.audient }<br />期限：一个月</td>
          <td height="44" valign="top" class="STYLE18">&nbsp;</td>
        </tr>
        <tr>
          <td height="44" valign="top">&nbsp;</td>
          <td width="142" height="44" valign="top">
	          <a href="${ctx }/servlet/serviceAuth?filmId=${film.id }&channelId=3&from=${requestScope.from}&ContentID=${film.contentId }" id="defaultFocus">
