...
function keyEvent() {
	...
	case 33://上一页
		if(curPage > 1){
			...
			var url = "${ctx }/crjy_hd/filmAction!listAssetByFilmId.do?filmId=${requestScope.filmID }&curPage="+pageNo;
			location.href = url;
		}
		return 0;
		break;
...
document.onkeypress = keyEvent;
	...
	function goto_play(id,fileID,ztID,filmId){
		...
		var backUrl = "${ctx}/crjy_hd/filmAction!listAssetByFilmId.do?filmId="+filmId+"&curPage=${pageBean.curPage}";
