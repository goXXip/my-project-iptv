      ...
      <table width="1112" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="256" height="70">
	          	<a href="${ctx }/crjy_hd/filmAction!listAssetByFilmId.do?filmId=${film.id}&channelId=3&from=${requestScope.from}" id="defaultFocus"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('play_img','','images/yyzj-gq-11-2.jpg',1)">
