...
function keyEvent() {
	...
	case 283:
			if(from == "index"){
				...
				location.href = "${ctx }/crjy_hd/filmAction!listFilmByColumnId.do?columnId=" +columnID +"&channelId=3";
			}
			else{
				location.href = "${ctx }/crjy_hd/filmAction!eduIndex.do";
			}
  ...
  <tr>
    ...
    <td width="1142" valign="top" bgcolor="214c47"><table width="100" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="1112" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top" class="STYLE28">集数：${film.serialCount }集 <br/>价格：20元包月</td>
          <td valign="top" class="STYLE28">适用：${film.audient }<br />期限：一个月</td>
          <td valign="top">&nbsp;</td>
        </tr>
        <tr>
          <td width="256" height="70">
	          	<a href="${ctx }/servlet/serviceAuth_hd?filmId=${film.id }&channelId=3&from=${requestScope.from}&ContentID=${film.contentId }" id="defaultFocus"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('play_img','','images/yyzj-gq-11-2.jpg',1)">
       ...
       <%@ include file="/crjy_hd/relative_fragment.jsp" %>
     </td>
